            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{ $t("translation.resetPassword") }}</h3>
                    </div>
                        ...
                        <div class="col-md-12">
                            <form class="form-horizontal" @submit.prevent="resetPassword">
                                <div :class="{ 'form-group': true, 'has-error': errors.has('email') }">
                                    ...
                                    <input id="email" type="email" class="form-control" name="email" v-model="email" v-validate="'required|email|max:255'">
